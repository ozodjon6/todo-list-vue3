<template>
    <Transition>
        <div id="createProductModal" tabindex="-1" aria-hidden="true" v-if="modalActive"
    ...
    <div v-if="modalActive" class="bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40"></div>
</template>
